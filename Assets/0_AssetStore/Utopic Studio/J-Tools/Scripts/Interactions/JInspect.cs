    ...
    public class JInspect : MonoBehaviour
    {
        ...
        public void Inspect(GameObject InspectTarget)
        {
            ...
            if (InspectTarget != null && InspectTarget != Target)
            {
                ...
                {
                    OriginalPlayerTransform = new JTrans(J.Instance.PlayerGameObject.transform);
                    MoveObject(J.Instance.PlayerGameObject.transform, PlayerCenter, false);
        ...
        public void FinishInspect(bool bForceCancel = false)
        {
            if (bForceCancel)
            {
                ...
                _CachedMultiMove.Cancel(J.Instance.PlayerGameObject.transform);
            }
            else
            {
                //Return player to its original position
                MoveObject(J.Instance.PlayerGameObject.transform, OriginalPlayerTransform, false);
            }
