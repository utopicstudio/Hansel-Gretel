...
public class OVRPlayerController : MonoBehaviour
{
	...
	protected virtual void UpdateController()
	{
        ...
        //This section has problems with slopes, as the controller tries to rellocate the character and it generates a way too big throttle
        //which cannot be damped down.
	...
	public virtual void UpdateMovement()
	{
		...
		if (EnableLinearMovement)
		{
			...
			if (OVRInput.Get(OVRInput.Button.DpadUp) || OVRInput.Get(OVRInput.Button.PrimaryTouchpad))
			{
				moveForward = true;
				dpad_move = true;
