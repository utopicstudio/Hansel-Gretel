...
namespace UnityStandardAssets.CrossPlatformInput
{
	...
	public class TouchPadNew : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
	{
		...
		public RectTransform esquinaSupDerecha;
		...
		void Update()
		{
			...
			if (CircleImage.enabled) {
				#if !UNITY_EDITOR
				CircleImage.rectTransform.anchoredPosition = new Vector3(Input.touches[0].position.x/Screen.width * esquinaSupDerecha.anchoredPosition.x, Input.touches[0].position.y/Screen.height * esquinaSupDerecha.anchoredPosition.y, 0f);
				#else
				CircleImage.rectTransform.anchoredPosition = new Vector3(Input.mousePosition.x/Screen.width * esquinaSupDerecha.anchoredPosition.x, Input.mousePosition.y/Screen.height * esquinaSupDerecha.anchoredPosition.y, 0f);
				#endif
			}
