...
namespace J.External
{
    public class PennerDoubleAnimation
    {
		...
		// ::: Custom Curves :::
		public static double SineUpDown( double t, double b, double c, double d )
		{
			return 0.5 * c * Math.Sin( t / d * 2*Math.PI + 2*Math.PI * 3/4 ) + b + c * 0.5;
		}

		public static double SineDownUp( double t, double b, double c, double d )
		{
			return 0.5 * c * Math.Sin( t / d * 2*Math.PI + 2*Math.PI * 1/4 ) + b + c * 0.5;
		}
